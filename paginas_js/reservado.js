...
function btn_reserva() {
    document.getElementById("fimquarto1").value = 'Caancelar Reserva'
}

function reservado_desfaz() {
...
function main() {
    ...
    var valor = document.getElementById("fimquarto1").value
    if (valor == 'Caancelar Reserva') {
        reservado_desfaz()
    }
}